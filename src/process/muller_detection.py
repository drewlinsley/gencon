...
def get_segmentation(
        ...
        # cell_ckpt_path='/cifs/data/tserre_lrs/projects/prj_connectomics/ffn_membrane_v2/celltype_ckpts/multiclass',
        ...
        membrane_slice=[64, 576, 576],  # 384, 384],  # 576
    ...
    if idx == 0:
        ...
        model_shape = [membrane_slice[0], vol.shape[2], vol.shape[3], 2]  # 1
        label_shape = [membrane_slice[0], vol.shape[2], vol.shape[3], 1]  # 1
